...
Builder/operator focused on practical AI systems, small-business revenue tooling, product prototypes, and delivery workflows that can be tested, shipped, and explained.

Portfolio: [teddyalston.com](https://teddyalston.com)

## What this GitHub is for

This account is organized as a proof-of-work layer for the portfolio site.

- Public repos are for inspectable sites, demos, and portfolio surfaces.
- Private repos hold active product work, client-sensitive experiments, and source that is better shown as case studies.
- Forks are upstream references, experiments, or dependency research, not the main portfolio signal.
...
| [FrequencyThreadsCo](https://www.etsy.com/shop/FrequencyThreadsCo) | Non-GitHub Etsy storefront and print-on-demand commerce case study. |

## Case-study work

These repositories and operating assets are intentionally handled at case-study level when source access is not appropriate:
...
- FrequencyThreadsCo: Etsy marketplace positioning, listing workflow, brand operations, and public-safe growth loops.
...
Pinned repositories should stay limited to original public work. Private repos should be represented through `teddyalston.com` case studies, not by exposing unfinished source.
